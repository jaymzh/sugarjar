class SugarJar
  class Commands
    ...
    alias branchclean bclean

    def rclean(name = nil, remote = nil)
      assert_in_repo!
      name ||= current_branch
      name = fprefix(name)
      remote ||= 'origin'
    ...
    alias remoteclean rclean

    def sclean(name = nil, remote = nil)
      assert_in_repo!
      name ||= current_branch
      remote ||= 'origin'
      bclean(name)
    ...
    alias branchcleanall bcleanall

    def rcleanall(remote = nil)
      assert_in_repo!
      curr = current_branch
      remote ||= 'origin'
    ...
    alias remotecleanall rcleanall

    def scleanall(remote = nil)
      assert_in_repo!
      bcleanall
      rcleanall(remote)
    end
    alias supercleanall scleanall
